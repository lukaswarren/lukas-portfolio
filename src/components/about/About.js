    ...
    <section id='about'>
        ...
        <div className='aboutContainer'>
            ...
            <div className="aboutContent">
                ...
                <p className="aboutPara">After 4 and half years at Clearwater I took some time off before starting as an Instructor and SME Engineer at Kenzie Academy. There I've been helping teach students how to build web-services that run on AWS using Lambda and DynamoDB. I helped automate the testing of the assignments building out unit tests and Gradle tasks in Github actions and workflows.</p>
            </div>
        </div>
